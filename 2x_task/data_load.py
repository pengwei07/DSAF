...
def data_load():
    ...
    A_reshaped = torch.tensor(data_in_mid, dtype=torch.float32)
    B_reshaped = torch.tensor(data_in_hr, dtype=torch.float32)
    C_reshaped = torch.tensor(data_out_mid, dtype=torch.float32)
    D_reshaped = torch.tensor(data_out_hr, dtype=torch.float32)
    E_reshaped = torch.tensor(geo_data_new_mid, dtype=torch.float32)
